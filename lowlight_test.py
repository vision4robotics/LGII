...
def lowlight(image_path):
    ...
    LGII_net = LGII_net.eval()
    LGII_net.load_state_dict(torch.load('snapshots/Epoch49.pth'))
    start = time.time()
    enhanced_image,r = LGII_net(data_lowlight)
    ...
    image_path1 = image_path.replace('result','mask')
